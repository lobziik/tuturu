...
log "  TUTURU_SFU_ENABLED: ${TUTURU_SFU_ENABLED:-false}"
log "  TUTURU_E2EE_MEDIA_ENABLED: ${TUTURU_E2EE_MEDIA_ENABLED:-true}"
...
TUTURU_SFU_ENABLED=${TUTURU_SFU_ENABLED:-false}
TUTURU_E2EE_MEDIA_ENABLED=${TUTURU_E2EE_MEDIA_ENABLED:-true}
EOF
